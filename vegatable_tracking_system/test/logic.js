//'use strict';
 ...
 // Write the unit tests for your transction processor functions here
  //@param {org.qt.hyperledger.namespace} SellArgs

 function OnSell(SellArgs){
    var AssetRegistry = SellArgs.sell.veggies ;
 }
...
const namespace = 'org.qt.hyperledger.namespace';
...
describe('#' + namespace, () => {
    ...
    describe('ChangeAssetValue()', () => {
        it('should change the value property of ' + assetType + ' to newValue', () => {
            ...
            const user = factory.newResource(namespace, 'User', 'Shantanu');
